        ...
        <div className="relative">
          ...
          <div className="relative z-10 flex items-center justify-between gap-4 px-6 py-5">
            ...
            <div className="flex-1 text-center">
              <h1 className="text-xl sm:text-2xl font-bold text-white drop-shadow-lg">{umkmData.namaUsaha}</h1>
              <p className="text-red-100 text-xs sm:text-sm mt-1 drop-shadow">Detail Toko & Produk</p>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-1">{umkmData.namaUsaha}</h2>
                <p className="text-gray-600 mb-2">{umkmData.namaPemilik}</p>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">{umkmData.deskripsi}</p>
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm">{umkmData.alamat}</span>
              </div>
              {umkmData.jamOperasional && (
                <div className="flex items-center gap-2 text-gray-600">
                  ...
                  <span className="text-sm">{umkmData.jamOperasional}</span>
                </div>
              )}
            </div>
            ...
            <button
              ...
              className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-xl transition-all shadow-lg flex items-center justify-center gap-2"
            >
        ...
        <div className="bg-white rounded-3xl p-4 shadow-lg mb-6">
          <div className="relative">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 bg-white text-gray-900"
            />
          ...
          {filteredProducts.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {filteredProducts.map((product) => (
                ...
                >
                  {/* Product Image */}
                  <div className="relative h-40 bg-gradient-to-br from-red-100 to-pink-100">
                  ...
                  {/* Product Info */}
                  <div className="p-4">
                    <h4 className="font-bold text-gray-900 mb-1 line-clamp-2 text-sm">{product.namaProduk}</h4>
                    <p className="text-red-600 font-bold mb-2">{formatRupiah(product.hargaProduk)}</p>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-100 text-sm">Informasi lengkap produk</p>
                  </div>
                </div>
                <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {selectedProduct.fotoProduk && selectedProduct.fotoProduk.length > 0 ? (
                    ...
                    <div className="col-span-2 w-full h-48 bg-gradient-to-br from-red-100 to-pink-100 rounded-xl flex items-center justify-center">
                      <svg className="w-16 h-16 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                      </svg>
                    </div>
              ...
              {/* Product Info */}
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{selectedProduct.namaProduk}</h3>
                ...
                <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-4 mb-4">
                  <p className="text-3xl font-bold text-red-600">{formatRupiah(selectedProduct.hargaProduk)}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed bg-gray-50 p-4 rounded-xl whitespace-pre-line">
            ...
            <div className="sticky bottom-0 bg-white border-t-2 border-gray-200 p-6 rounded-b-3xl">
              <button
                ...
                className="w-full px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-2xl shadow-lg transition-all flex items-center justify-center gap-3 hover:scale-105 duration-300"
              >
