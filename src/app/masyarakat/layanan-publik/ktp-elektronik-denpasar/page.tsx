...
export default function KtpElektronikDenpasarPage() {
  ...
  const fetchContent = async () => {
    try {
      setLoading(true);
      const data = await getServiceContent('ktp-elektronik-denpasar');
      setContent(data);
    } catch (error) {
  ...
  return (
    <main className="min-h-[100svh] bg-gradient-to-br from-red-50 via-pink-50 to-red-50">
      <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 pb-32 pt-4">
        <HeaderCard title="KTP Elektronik Denpasar" backUrl="/masyarakat/layanan-publik/pelayanan-taring-dukcapil" showBackButton={true} />
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">KTP Elektronik Denpasar</h2>
