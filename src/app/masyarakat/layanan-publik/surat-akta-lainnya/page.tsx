...
export default function SuratAktaLainnyaPage() {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) => handleInputChange("kategoriSurat", e.target.value)}
              required
            >
              <option value="">Pilih Kategori</option>
              {kategoriSuratOptions.map((kategori) => (
          ...
          <div className="space-y-2">
            ...
            <input
              type="text"
              className="w-full rounded-xl border border-red-100 bg-white/95 px-4 py-3 text-sm shadow-sm ring-1 ring-red-200 focus:outline-none focus:ring-2 focus:ring-red-500"
              placeholder="Input Jenis Surat/Akta"
          ...
          <div className="space-y-2">
            ...
            <textarea
              rows={4}
              className="w-full rounded-xl border border-red-100 bg-white/95 px-4 py-3 text-sm shadow-sm ring-1 ring-red-200 focus:outline-none focus:ring-2 focus:ring-red-500"
              placeholder="Jelaskan keperluan dan detail surat/akta yang dibutuhkan"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">
                Foto/Dokumen Tambahan (Opsional)
              </label>
              <div className="flex items-center gap-3">
                <input
                  type="file"
                  ...
                  className="hidden"
                  id="fotoTambahan"
                  onChange={(e) => handleFileChange("fotoTambahan", e.target.files?.[0] || null)}
                />
                <label
                ...
                >
                  <DocumentIcon className="h-5 w-5 text-red-500" />
                  <span className="text-gray-600">
                    {formData.fotoTambahan ? formData.fotoTambahan.name : "Pilih file"}
                  </span>
                </label>
              </div>
            </div>
